...
"""Verify that starting barrelcrudecoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start barrelcrudecoin with -h for help text")
        ...
        self.log.info("Start barrelcrudecoin with -version for version information")
        ...
        self.log.info("Start barrelcrudecoind with -fakearg to make sure it does not start")
