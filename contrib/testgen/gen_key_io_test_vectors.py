...
bech32_templates = [
  ...
  ('bcc',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('bcc',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('bcc',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tbcc',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tbcc',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tbcc',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rbcc',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rbcc',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rbcc', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tbcc',  17, 32, False, False, False),
  ('rbcc',  3,  1, False, False, False),
  ('bcc',   15, 41, False, False, False),
  ('tbcc',  0, 16, False, False, False),
  ('rbcc',  0, 32, True,  False, False),
  ('bcc',   0, 16, True,  False, False),
  ('tbcc',  0, 32, False, True,  False),
  ('rbcc',  0, 20, False, False, True)
]
