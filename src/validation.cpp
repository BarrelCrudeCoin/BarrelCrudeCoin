...
#if defined(NDEBUG)
# error "BarrelCrudeCoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "BarrelCrudeCoin Signed Message:\n";
...
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams)
{
    ...
    // Subsidy is cut in half at halving
    nSubsidy >>= halvings;
    return nSubsidy;
}
...
void ThreadScriptCheck() {
    RenameThread("barrelcrudecoin-scriptch");
