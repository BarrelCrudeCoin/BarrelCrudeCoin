...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " barrelcrudecoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  barrelcrudecoin-tx [options] <hex-tx> [commands]  Update hex-encoded barrelcrudecoin transaction\n" +
            "or:     barrelcrudecoin-tx [options] -create [commands]   Create hex-encoded barrelcrudecoin transaction\n" +
            "\n";
